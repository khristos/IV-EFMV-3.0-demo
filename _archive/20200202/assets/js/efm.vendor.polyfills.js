      ...
      var h = function(t) {
          ...
          p = (function() {
              function t() {
                  ...
                  this.props = n({}, i, {}, e), this.props.viewport && this.props.viewport instanceof Element ? this.props.content ? (this.viewport = {
                      width: this.props.viewport.clientWidth,
                      height: this.props.viewport.clientHeight
                  }, this.content = {
                      width: h(this.props.content),
                      height: c(this.props.content)
                  }, this.position = {
                      x: 0,
                      y: 0
                  }, this.velocity = {
                      ...
                      x: 0,
                      y: 0
                  }, this.dragOffset = n({}, this.dragStartPosition), this.dragPosition = n({}, this.position), this.isTargetScroll = !1, this.targetPosition = {
                      x: 0,
                      y: 0
                  }, this.isScrolling = !1, this.scrollOffset = {
                      x: 0,
                      y: 0
                      ...
                      to: 0
                  }, this.isRunning = !1, this.rafID = null, this.events = {}, this.animate(), this.handleEvents()) : console.error("ScrollBooster init error: Viewport does not have any content") : console.error('ScrollBooster init error: "viewport" config property must be present and must be Element')
              }
              var e, i, o;
              return e = t, (i = [{
                  key: "run",
                  ...
                  value: function() {
                      var t = this;
                      this.isRunning && (this.update(), this.props.onUpdate(this.getState()), this.rafID = requestAnimationFrame((function() {
                          return t.animate()
                      })))
                  }
              }, {
                  key: "isMoving",
                  value: function() {
                      return this.isDragging || this.isScrolling || Math.abs(this.velocity.x) >= .1 || Math.abs(this.velocity.y) >= .1
                  }
              }, {
                  key: "update",
                  value: function() {
                      this.applyBoundForce(), this.applyDragForce(), this.applyScrollForce(), this.applyTargetForce(), this.velocity.x *= this.friction, this.velocity.y *= this.friction, "vertical" !== this.props.direction && (this.position.x += this.velocity.x), "horizontal" !== this.props.direction && (this.position.y += this.velocity.y), this.bounce && !this.isScrolling || this.isTargetScroll || (this.position.x = Math.max(Math.min(this.position.x, this.boundX.to), this.boundX.from), this.position.y = Math.max(Math.min(this.position.y, this.boundY.to), this.boundY.from)), this.isMoving() || (this.isRunning = !1, this.isTargetScroll = !1)
                  }
              }, {
                  key: "applyForce",
                  value: function(t) {
                  ...
                  value: function() {
                      if (this.bounce && !this.isDragging) {
                          var t = this.position.x < this.boundX.from,
                              ...
                              i = this.position.y < this.boundY.from,
                              o = this.position.y > this.boundY.to,
                              n = t || e,
                              s = i || o;
                          if (n || s) {
                              var r = t ? this.boundX.from : this.boundX.to,
                                  h = i ? this.boundY.from : this.boundY.to,
                                  c = r - this.position.x,
                                  p = h - this.position.y,
                                  l = {
                                      x: c * this.bounceForce,
                                      y: p * this.bounceForce
                                  },
                                  a = this.position.x + (this.velocity.x + l.x) / (1 - this.friction),
                                  u = this.position.y + (this.velocity.y + l.y) / (1 - this.friction);
                              (t && a >= this.boundX.from || e && a <= this.boundX.to) && (l.x = c * this.bounceForce - this.velocity.x), (i && u >= this.boundY.from || o && u <= this.boundY.to) && (l.y = p * this.bounceForce - this.velocity.y), this.applyForce({
                                  x: n ? l.x : 0,
                                  y: s ? l.y : 0
                              })
                          }
                  ...
                  value: function() {
                      ...
                      this.isTargetScroll = !0, this.targetPosition.x = -t.x || 0, this.targetPosition.y = -t.y || 0, this.run()
                  }
              }, {
                  key: "setPosition",
                  value: function() {
                  ...
                  key: "updateMetrics",
                  value: function() {
                      this.viewport.width = this.props.viewport.clientWidth, this.viewport.height = this.props.viewport.clientHeight, this.content.width = h(this.props.content), this.content.height = c(this.props.content), this.boundX.from = Math.min(-this.content.width + this.viewport.width, 0), this.boundY.from = Math.min(-this.content.height + this.viewport.height, 0), this.run()
                  }
              }, {
                  key: "handleEvents",
                  value: function() {
                      ...
                      this.events.pointerdown = function(i) {
                          ...
                          if (!(c - a.left >= l.clientLeft + l.clientWidth) && !(p - a.top >= l.clientTop + l.clientHeight) && t.props.shouldScroll(t.getState(), i) && ("mouse" !== t.props.pointerMode || !o) && ("touch" !== t.props.pointerMode || o) && !(t.props.inputsFocus && ["input", "textarea", "button", "select", "label"].indexOf(i.target.nodeName.toLowerCase()) > -1)) {
                              if (t.textSelection) {
                                  if (function(t, e, i) {
                                          for (var o = t.childNodes, n = document.createRange(), s = 0; s < o.length; s++) {
                                              ...
                                              if (3 === r.nodeType) {
                                                  ...
                                                  if (e >= h.left && i >= h.top && e <= h.right && i <= h.bottom) return r
                                              }
                                          }
                                          return !1
                                      }(i.target, c, p)) return;
                              ...
                              var u;
                              t.isDragging = !0, e.x = r, e.y = h, t.dragStartPosition.x = t.position.x, t.dragStartPosition.y = t.position.y, n(i), t.run(), i.preventDefault()
                          }
                          ...
                          t.props.emulateScroll && (t.velocity.x = 0, t.velocity.y = 0, t.isScrolling = !0, t.scrollOffset.x = -e.deltaX, t.scrollOffset.y = -e.deltaY, t.run(), clearTimeout(i), i = setTimeout((function() {
                  ...
                  value: function() {
                      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                      this.props = n({}, this.props, {}, t), this.props.onUpdate(this.getState()), this.run()
                  }
              }, {
                  key: "destroy",
                  value: function() {
